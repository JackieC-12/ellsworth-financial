    ...
    return (
        <div className="py-24 sm:py-32">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 bg-white mt-16 p-20">
            ...
            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 grid-auto-max gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              {links.map((link) => (
