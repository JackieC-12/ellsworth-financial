            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="pr-4">
                        ...
                        <p className="mt-6 text-lg/8 text-gray-600 text-center sm:text-left">At Ellsworth Financial, we concentrate in foundational family finance, offering a range of services designed to protect and grow your wealth.
