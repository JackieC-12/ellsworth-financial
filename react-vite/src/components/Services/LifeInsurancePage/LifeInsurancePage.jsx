      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 pb-24">
        <div className="mx-auto max-w-2xl gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none">
          <div className="sm:text-left">
              ...
              Protect your loved ones and secure your legacy with our life insurance solutions.
              We offer principal-protected living and death benefits through equity-indexed accounts,
              ensuring that your family&apos;s financial future is safeguarded.
              Our team will help you select the right policy to meet your needs and provide peace of mind.
              </p>
          </div>
        </div>
      </div>
