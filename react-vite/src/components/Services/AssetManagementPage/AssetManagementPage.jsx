      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 pb-24">
        <div className="mx-auto max-w-2xl gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none">
          <div className="sm:text-left">
              ...
              Our asset management services include the strategic allocation of stocks, bonds, ETFs, and custom notes in balanced portfolios.
              We work closely with you to develop an investment strategy that aligns with your risk tolerance and financial goals,
              aiming to maximize returns while managing risk.
              </p>
          </div>
        </div>
      </div>
